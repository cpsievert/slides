...
[RSelenium](http://cran.r-project.org/web/packages/RSelenium/index.html) allows us to control _any_ web browser we want from the R console (so we can access the DOM!!).
