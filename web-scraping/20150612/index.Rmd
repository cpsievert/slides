...
> - [ropensci](https://ropensci.org/) has a [ton of R packages](https://ropensci.org/packages/) providing clean interfaces to open data.
> - The [Web Technologies and Services CRAN Task View](http://cran.r-project.org/web/views/WebTechnologies.html) is a great overview of various tools for working with data that lives on the web.
...
[See here](https://gist.github.com/cpsievert/57be009120bb5298affa) for a solution
