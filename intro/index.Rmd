...
<ul class="build">
What if you don't know what function(s) to use?

Google! (I like to prefix "CRAN" in my search; others might suggest <http://www.rseek.org/>)

Stackoverflow!

<img src="so-raw.png" width="600" height="300">
</ul>
