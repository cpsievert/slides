...
__Hard__: Can you create an animation? (Hint: you might need to `install.packages("animation")` and look at the `fig.show` chunk option)
...
Copy/paste the chunk hook (on the previous slide) into your R Markdown file. Notice th difference in margins.
